...
public class CategoryItemsActivity extends AppCompatActivity {
    ...
    private FloatingActionButton addItemFloatingActionBtn;
    Category category;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemsRecyclerView = findViewById(R.id.items_recicler_view);

        itemsRecyclerView.setAdapter(new ItemsRecyclerAdapter(category));
        itemsRecyclerView.setLayoutManager(new LinearLayoutManager(this));

        addItemFloatingActionBtn = findViewById(R.id.add_item_btn);

        addItemFloatingActionBtn.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void displayItemCreationDialog() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.positive_btn_item, new DialogInterface.OnClickListener() {
                    @Override
